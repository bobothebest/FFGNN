...
import utils
from utils import load_paper_features
...
# Add after loading graph data
paper_features = load_paper_features('./processed/paper_features.npy', node_dict)
paper_features = paper_features.to(device)
...
tgan = TGAN(train_ngh_finder, 
            ...
            edge_num=EDGE_NUM, 
            feat_dim=FEAT_DIM,
            paper_features=paper_features,  # Add this line
            device=device,
